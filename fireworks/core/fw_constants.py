...
USER_PACKAGES = ['fireworks.utilities.tests', 'fireworks.user_objects', 'fireworks.core', 'fw_tutorials.task']  # this is where load_object() looks for serialized objects

...
class FWConfig(object):
    def __init__(self):
        ...
        self.FW_NAME_UPDATES = {'Transfer Task': 'FileTransferTask', 'Script Task': 'ScriptTask'}  # if you update a _fw_name, you can use this to record the change and maintain
        # deserialization

This example shows you can define and run a custom Firetask in the most simple way. There is an online tutorial on custom Firetasks here: https://hackingmaterials.lbl.gov/fireworks/guide_to_writing_firetasks.html

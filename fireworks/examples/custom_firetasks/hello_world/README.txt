This example shows you can define and run a custom FireTask in the most simple way. You might try modifying this example to produce more complex behavior.

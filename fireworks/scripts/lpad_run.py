...
def lpad():
    ...
    defuse_wf_parser = subparsers.add_parser('defuse_wfs', help='cancel (de-fuse) an entire Workflow')
    ...
    reignite_wfs_parser = subparsers.add_parser('reignite_wfs', help='reignite (un-cancel) an entire Workflow')
